        ...
        <div class="col-xl-3 col-lg-3 col-md-6 flex-fill">
            <div class="product-03-wrapper grey-2-bg pos-rel text-center mb-30">
                <div class="badge-tag">
                    ...
                    ${
                        isNew
                            ? `<span class="product-tag pro-tag hot-2">New</span>`
                            : ""
                    }
                    ${
                        offerText
                            ? `<span class="product-tag pro-tag">${offerText}</span>`
                            : ""
                    }
                </div>
                <div class="product-02-img pos-rel">
                    ...
                    <div class="product-action">
                        ...
                        <button class="action-btn add-to-cart-btn" data-variant-id="${
                            product.id
                        }">
        ...
        <div class="product-list-content mb-30 d-flex align-items-center">
            ...
            <div>
                ...
                <div class="product-action product-02-action">
                    ...
                    <button class="c-btn add-to-cart-btn" data-variant-id="${
                        product.id
                    }">
...
function render_pagination(pagination) {
    ...
    if (pagination.current_page > 1) {
        $wrapper.append(
            `<li><a href="#" class="page-link" data-page="${
