                          ...
                          <tr style="vertical-align: top" valign="top">
                            <td class="divider_inner"
                              ...
                              <table align="center" border="0" cellpadding="0" cellspacing="0"
                                class="divider_content" height="01" role="presentation"
                                style="
                                    table-layout: fixed;
                                    vertical-align: top;
                                    border-spacing: 0;
                        ...
                        <div class="txtTinyMce-wrapper"
                          ...
                          <p
                            style="
                              ...
                              ">
                            Order number:
                            <span style="color: #39767b"><strong>{{ $order->reference_number }}</strong></span>
                          </p>
                        </div>
                      </div>
                      <!--[if mso]></td></tr></table><![endif]-->
                          ...
                          <div class="txtTinyMce-wrapper"
                            ...
                            <p
                              style="
                                ...
                                margin: 0;
                              ">
                              {{ $item->productVariant->product->translation->name }}
                            </p>
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div class="txtTinyMce-wrapper"
                          ...
                          <p
                            style="
                                ...
                                ">
                            <span
                              style="font-size: 16px">{{ price_format($order->currency->code, $order->sub_total) }}</span>
                          </p>
                        </div>
                      </div>
                      <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div class="txtTinyMce-wrapper"
                          ...
                          <p
                            style="
                                    ...
                                    margin: 0;
                                ">
                            <span style="font-size: 16px"><strong>Tax</strong></span>
                          </p>
                        </div>
                      </div>
                      <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div class="txtTinyMce-wrapper"
                          ...
                          <p
                            style="
                                ...
                                ">
                            <span
                              style="font-size: 16px">{{ price_format($order->currency->code, $order->tax) }}</span>
                          </p>
                        </div>
                      </div>
                      <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div class="txtTinyMce-wrapper"
                          ...
                          <p
                            style="
                                ...
                                margin: 0;
                              ">
                            <span style="font-size: 22px"><strong><span style="">Total {{ price_format($order->currency->code, $order->total) }}</span></strong></span>
                          </p>
                        </div>
                      </div>
                      <!--[if mso]></td></tr></table><![endif]-->
                      ...
                      <div align="center" class="button-container"
                        ...
                        <a href="{{ route('home') }}"
                          style="
                              ...
                              width: auto;
                              width: auto;
                              border-top: 1px solid #39767b;
                              border-right: 1px solid #39767b;
                              border-bottom: 1px solid #39767b;
                              border-left: 1px solid #39767b;
                              padding-top: 5px;
                              padding-bottom: 5px;
                              font-family: Nunito, Arial, Helvetica Neue,
                                Helvetica, sans-serif;
