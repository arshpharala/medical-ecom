...
<head>
    ...
    <title>{{ setting('site_title', 'Optimized Medical Supplies') }}</title>
    ...
    <!-- DataTables -->
    <link rel="stylesheet"
        href="{{ asset('theme/adminlte/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('theme/adminlte/plugins/datatables-responsive/css/responsive.bootstrap4.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('theme/adminlte/plugins/datatables-buttons/css/buttons.bootstrap4.min.css') }}">
