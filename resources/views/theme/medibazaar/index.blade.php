...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="theme/medibazaar/assets/img/favicon.ico">
    <!-- Place favicon.ico in the root directory -->

    <!-- CSS here -->
    <!-- <link rel="stylesheet" href="theme/medibazaar/assets/css/bootstrap.min.css"> -->
    <link rel="stylesheet" href="theme/medibazaar/assets/css/owl.carousel.min.css">
    <link rel="stylesheet" href="theme/medibazaar/assets/css/animate.min.css">
    <link rel="stylesheet" href="theme/medibazaar/assets/css/magnific-popup.css">
    <link rel="stylesheet" href="theme/medibazaar/assets/css/fontawesome-all.min.css">
    <link rel="stylesheet" href="theme/medibazaar/assets/css/themify-icons.css">
    <link rel="stylesheet" href="theme/medibazaar/assets/css/meanmenu.css">
    <link rel="stylesheet" href="theme/medibazaar/assets/css/slick.css">
    <link rel="stylesheet" href="theme/medibazaar/assets/css/main.css">
    <link rel="stylesheet" href="theme/medibazaar/assets/css/responsive.css">
...
<body>
    ...
    <header>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-3">
                        <div class="logo">
                            <a href="index.html"><img src="theme/medibazaar/assets/img/logo/logo.png"
                                    alt="" /></a>
                        </div>
                    </div>
                    <div class="col-xl-9 col-lg-9 d-none d-lg-block">
                        <div class="header-right f-right">
                            <div class="header-lang f-right pos-rel d-none d-md-none d-lg-block">
                                <div class="lang-icon">
                                    <img src="theme/medibazaar/assets/img/icon/flag.png" alt="">
        ...
        <div class="extra-info">
            ...
            <div class="logo-side mb-30">
                <a href="index.html">
                    <img src="theme/medibazaar/assets/img/logo/white-logo.png" alt="" />
                </a>
            </div>
            ...
            <div class="instagram">
                <a href="#">
                    <img src="theme/medibazaar/assets/img/portfolio/p1.jpg" alt="">
                </a>
                <a href="#">
                    <img src="theme/medibazaar/assets/img/portfolio/p2.jpg" alt="">
                </a>
                <a href="#">
                    <img src="theme/medibazaar/assets/img/portfolio/p3.jpg" alt="">
                </a>
                <a href="#">
                    <img src="theme/medibazaar/assets/img/portfolio/p4.jpg" alt="">
                </a>
                <a href="#">
                    <img src="theme/medibazaar/assets/img/portfolio/p5.jpg" alt="">
                </a>
                <a href="#">
                    <img src="theme/medibazaar/assets/img/portfolio/p6.jpg" alt="">
                </a>
            </div>
    ...
    <main>
                                    ...
                                    <div class="col-xl-5 col-lg-6">
                                        <div class="hero-text mt-90">
                                            ...
                                            <div class="hero-slider-btn">
                                                @if ($banner->btn_link)
                                                    <a data-animation="fadeInUp" data-delay=".8s"
                                                        href="{{ $banner->btn_link }}" class="c-btn"
                                                ...
                                                <div class="b-button" data-animation="fadeInUp" data-delay="1s"
                                                    ...
                                                    <a href="{{ route('products') }}">explore collection <i
                            ...
                            <div class="banner-wrapper mb-30">
                                <div class="banner-img pos-rel">
                                    <a href="product-details.html"><img
                                            src="theme/medibazaar/assets/img/banner/01.jpg" alt=""></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="product-tab mb-25">
                                <ul class="nav justify-content-start justify-content-lg-end product-nav"
                            ...
                            <div class="row">
                                    ...
                                    <div class="product-wrapper text-center mb-45">
                                        <div class="product-img pos-rel">
                                            <a href="product-details.html">
                                                <img src="theme/medibazaar/assets/img/products/01.jpg" alt="">
                                                <img class="secondary-img"
                                                    src="theme/medibazaar/assets/img/products/02.jpg" alt="">
                                            </a>
                                ...
                                <div class="col-xl-4 cl-lg-4 col-md-6">
                                    <div class="product-wrapper text-center mb-45">
                                        <div class="product-img pos-rel">
                                            <a href="product-details.html">
                                                <img src="theme/medibazaar/assets/img/products/02.jpg" alt="">
                                                <img class="secondary-img"
                                                    src="theme/medibazaar/assets/img/products/03.jpg" alt="">
                                            </a>
                                            <div class="product-action">
                                                <a class="action-btn" href="#"><i class="far fa-heart"></i></a>
                                                <a class="c-btn" href="#">add to cart <i
                                ...
                                <div class="col-xl-4 cl-lg-4 col-md-6">
                                    <div class="product-wrapper text-center mb-45">
                                        <div class="product-img pos-rel">
                                            <a href="product-details.html">
                                                <img src="theme/medibazaar/assets/img/products/03.jpg" alt="">
                                                <img class="secondary-img"
                                                    src="theme/medibazaar/assets/img/products/04.jpg" alt="">
                                            </a>
                                            <div class="product-action">
                                                <a class="action-btn" href="#"><i class="far fa-heart"></i></a>
                                                <a class="c-btn" href="#">add to cart <i
                                ...
                                <div class="col-xl-4 cl-lg-4 col-md-6">
                                    <div class="product-wrapper text-center mb-45">
                                        <div class="product-img pos-rel">
                                            <a href="product-details.html">
                                                <img src="theme/medibazaar/assets/img/products/04.jpg" alt="">
                                                <img class="secondary-img"
                                                    src="theme/medibazaar/assets/img/products/05.jpg" alt="">
                                            </a>
                                            <div class="product-action">
                                                <a class="action-btn" href="#"><i class="far fa-heart"></i></a>
                                                <a class="c-btn" href="#">add to cart <i
                                ...
                                <div class="col-xl-4 cl-lg-4 col-md-6">
                                    <div class="product-wrapper text-center mb-45">
                                        <div class="product-img pos-rel">
                                            <a href="product-details.html">
                                                <img src="theme/medibazaar/assets/img/products/05.jpg" alt="">
                                                <img class="secondary-img"
                                                    src="theme/medibazaar/assets/img/products/06.jpg" alt="">
                                            </a>
                                            <div class="product-action">
                                                <a class="action-btn" href="#"><i class="far fa-heart"></i></a>
                                                <a class="c-btn" href="#">add to cart <i
                                ...
                                <div class="col-xl-4 cl-lg-4 col-md-6">
                                    <div class="product-wrapper text-center mb-45">
                                        <div class="product-img pos-rel">
                                            <a href="product-details.html">
                                                <img src="theme/medibazaar/assets/img/products/06.jpg" alt="">
                                                <img class="secondary-img"
                                                    src="theme/medibazaar/assets/img/products/01.jpg" alt="">
                                            </a>
                                            <div class="product-action">
                                                <a class="action-btn" href="#"><i class="far fa-heart"></i></a>
                                                <a class="c-btn" href="#">add to cart <i
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="banner-02-wrapper text-center mb-30" data-bg-color="#edf7fb">
                            ...
                            <div class="banner-02-img pos-rel">
                                <a href="#"><img src="theme/medibazaar/assets/img/banner/b-01.png"
                                        alt=""></a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="banner-02-wrapper text-center mb-30" data-bg-color="#f8f8f8">
                            ...
                            <div class="banner-02-img pos-rel">
                                <a href="#"><img src="theme/medibazaar/assets/img/banner/b-02.png"
                                        alt=""></a>
                                <span class="banner-tag">hot</span>
                            </div>
                            <div class="banner-price">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="banner-02-wrapper text-center mb-30" data-bg-color="#f3f8ff">
                            ...
                            <div class="banner-02-img pos-rel">
                                <a href="#"><img src="theme/medibazaar/assets/img/banner/b-03.png"
                                        alt=""></a>
                                <span class="banner-tag">hot</span>
                            </div>
                            <div class="banner-price">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="product-02-wrapper pos-rel text-center mb-30">
                            <div class="product-02-img pos-rel">
                                <a href="product-details.html">
                                    <img src="theme/medibazaar/assets/img/products/p-08.png" alt="">
                                </a>
                                <div class="product-action">
                                    <a class="action-btn" href="#"><i class="far fa-heart"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="product-02-wrapper pos-rel text-center mb-30">
                            <div class="product-02-img pos-rel">
                                <a href="product-details.html">
                                    <img src="theme/medibazaar/assets/img/products/p-01.png" alt="">
                                </a>
                                <div class="product-action">
                                    <a class="action-btn" href="#"><i class="far fa-heart"></i></a>
                                    <a class="action-btn" href="#"><i class="far fa-cart-plus"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="product-02-wrapper pos-rel text-center mb-30">
                            <div class="product-02-img pos-rel">
                                <a href="product-details.html">
                                    <img src="theme/medibazaar/assets/img/products/p-02.png" alt="">
                                </a>
                                <div class="product-action">
                                    <a class="action-btn" href="#"><i class="far fa-heart"></i></a>
                                    <a class="action-btn" href="#"><i class="far fa-cart-plus"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="product-02-wrapper pos-rel text-center mb-30">
                            <div class="product-02-img pos-rel">
                                <a href="product-details.html">
                                    <img src="theme/medibazaar/assets/img/products/p-03.png" alt="">
                                </a>
                                <div class="product-action">
                                    <a class="action-btn" href="#"><i class="far fa-heart"></i></a>
                                    <a class="action-btn" href="#"><i class="far fa-cart-plus"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="product-02-wrapper pos-rel text-center mb-30">
                            <div class="product-02-img pos-rel">
                                <a href="product-details.html">
                                    <img src="theme/medibazaar/assets/img/products/p-04.png" alt="">
                                </a>
                                <div class="product-action">
                                    <a class="action-btn" href="#"><i class="far fa-heart"></i></a>
                                    <a class="action-btn" href="#"><i class="far fa-cart-plus"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="product-02-wrapper pos-rel text-center mb-30">
                            <div class="product-02-img pos-rel">
                                <a href="product-details.html">
                                    <img src="theme/medibazaar/assets/img/products/p-05.png" alt="">
                                </a>
                                <div class="product-action">
                                    <a class="action-btn" href="#"><i class="far fa-heart"></i></a>
                                    <a class="action-btn" href="#"><i class="far fa-cart-plus"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="product-02-wrapper pos-rel text-center mb-30">
                            <div class="product-02-img pos-rel">
                                <a href="product-details.html">
                                    <img src="theme/medibazaar/assets/img/products/p-06.png" alt="">
                                </a>
                                <div class="product-action">
                                    <a class="action-btn" href="#"><i class="far fa-heart"></i></a>
                                    <a class="action-btn" href="#"><i class="far fa-cart-plus"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="product-02-wrapper pos-rel text-center mb-30">
                            <div class="product-02-img pos-rel">
                                <a href="product-details.html">
                                    <img src="theme/medibazaar/assets/img/products/p-07.png" alt="">
                                </a>
                                <div class="product-action">
                                    <a class="action-btn" href="#"><i class="far fa-heart"></i></a>
                                    <a class="action-btn" href="#"><i class="far fa-cart-plus"></i></a>
        ...
        <div class="testimonial-area pt-100 pb-175" data-background="theme/medibazaar/assets/img/bg/test.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 offset-lg-3 offset-xl-3">
                        <div class="section-title text-center mb-65">
                ...
                <div class="row test-active">
                    <div class="col-xl-6">
                        <div class="testimonial-wrapper">
                            <div class="inner-test d-flex justify-content-between align-items-center">
                                <div class="test-img">
                                    <img src="theme/medibazaar/assets/img/testimonial/01.png" alt="">
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="testimonial-wrapper">
                            <div class="inner-test d-flex justify-content-between align-items-center">
                                <div class="test-img">
                                    <img src="theme/medibazaar/assets/img/testimonial/02.png" alt="">
                                </div>
                                <div class="test-rating">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="blog-wrapper mb-30">
                            <div class="blog-img pos-rel">
                                <a href="blog-details.html"><img src="theme/medibazaar/assets/img/blog/01.jpg"
                                        alt=""></a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="blog-wrapper mb-30">
                            <div class="blog-img pos-rel">
                                <a href="blog-details.html"><img src="theme/medibazaar/assets/img/blog/02.jpg"
                                        alt=""></a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="blog-wrapper mb-30">
                            <div class="blog-img pos-rel">
                                <a href="blog-details.html"><img src="theme/medibazaar/assets/img/blog/03.jpg"
                                        alt=""></a>
                ...
                <div class="row">
                    <div class="col-xl-2 col-lg-2 col-md-3 col-6">
                        <div class="single-brand mb-60">
                            <img src="theme/medibazaar/assets/img/brand/01.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-3 col-6">
                        <div class="single-brand mb-60">
                            <img src="theme/medibazaar/assets/img/brand/02.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-3 col-6">
                        <div class="single-brand mb-60">
                            <img src="theme/medibazaar/assets/img/brand/03.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-3 col-6">
                        <div class="single-brand mb-60">
                            <img src="theme/medibazaar/assets/img/brand/04.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-3 col-6">
                        <div class="single-brand mb-60">
                            <img src="theme/medibazaar/assets/img/brand/05.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-3 col-6">
                        <div class="single-brand mb-60">
                            <img src="theme/medibazaar/assets/img/brand/06.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-3 col-6">
                        <div class="single-brand mb-60">
                            <img src="theme/medibazaar/assets/img/brand/07.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-3 col-6">
                        <div class="single-brand mb-60">
                            <img src="theme/medibazaar/assets/img/brand/08.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-3 col-6">
                        <div class="single-brand mb-60">
                            <img src="theme/medibazaar/assets/img/brand/09.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-3 col-6">
                        <div class="single-brand mb-60">
                            <img src="theme/medibazaar/assets/img/brand/10.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-3 col-6">
                        <div class="single-brand mb-60">
                            <img src="theme/medibazaar/assets/img/brand/11.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-3 col-6">
                        <div class="single-brand mb-60">
                            <img src="theme/medibazaar/assets/img/brand/12.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row instagram-active">
                    <div class="col-xl-2 p-0">
                        <div class="instagram-wrapper">
                            <div class="instagram-img">
                                <a href="#"><img src="theme/medibazaar/assets/img/instagram/01.jpg"
                                        alt="">
                    ...
                    <div class="col-xl-2 p-0">
                        <div class="instagram-wrapper">
                            <div class="instagram-img">
                                <a href="#"><img src="theme/medibazaar/assets/img/instagram/02.jpg"
                                        alt="">
                                    <div class="instagram-icon">
                                        <i class="fab fa-instagram"></i>
                                    </div>
                    ...
                    <div class="col-xl-2 p-0">
                        <div class="instagram-wrapper">
                            <div class="instagram-img">
                                <a href="#"><img src="theme/medibazaar/assets/img/instagram/03.jpg"
                                        alt="">
                                    <div class="instagram-icon">
                                        <i class="fab fa-instagram"></i>
                                    </div>
                    ...
                    <div class="col-xl-2 p-0">
                        <div class="instagram-wrapper">
                            <div class="instagram-img">
                                <a href="#"><img src="theme/medibazaar/assets/img/instagram/04.jpg"
                                        alt="">
                                    <div class="instagram-icon">
                                        <i class="fab fa-instagram"></i>
                                    </div>
                    ...
                    <div class="col-xl-2 p-0">
                        <div class="instagram-wrapper">
                            <div class="instagram-img">
                                <a href="#"><img src="theme/medibazaar/assets/img/instagram/05.jpg"
                                        alt="">
                                    <div class="instagram-icon">
                                        <i class="fab fa-instagram"></i>
                                    </div>
                    ...
                    <div class="col-xl-2 p-0">
                        <div class="instagram-wrapper">
                            <div class="instagram-img">
                                <a href="#"><img src="theme/medibazaar/assets/img/instagram/06.jpg"
                                        alt="">
                                    <div class="instagram-icon">
                                        <i class="fab fa-instagram"></i>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="footer-wrapper ml-130 mb-30">
                            ...
                            <div class="footer-img">
                                <img src="theme/medibazaar/assets/img/footer/footer.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- JS here -->
    <script src="theme/medibazaar/assets/js/vendor/modernizr-3.5.0.min.js"></script>
    <script src="theme/medibazaar/assets/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="theme/medibazaar/assets/js/popper.min.js"></script>
    <script src="theme/medibazaar/assets/js/bootstrap.min.js"></script>
    <script src="theme/medibazaar/assets/js/owl.carousel.min.js"></script>
    <script src="theme/medibazaar/assets/js/isotope.pkgd.min.js"></script>
    <script src="theme/medibazaar/assets/js/slick.min.js"></script>
    <script src="theme/medibazaar/assets/js/jquery.meanmenu.min.js"></script>
    <script src="theme/medibazaar/assets/js/ajax-form.js"></script>
    <script src="theme/medibazaar/assets/js/wow.min.js"></script>
    <script src="theme/medibazaar/assets/js/waypoints.min.js"></script>
    <script src="theme/medibazaar/assets/js/jquery.appear.js"></script>
    <script src="theme/medibazaar/assets/js/jquery.countdown.min.js"></script>
    <script src="theme/medibazaar/assets/js/jquery.knob.js"></script>
    <script src="theme/medibazaar/assets/js/jquery.counterup.min.js"></script>
    <script src="theme/medibazaar/assets/js/jquery.scrollUp.min.js"></script>
    <script src="theme/medibazaar/assets/js/imagesloaded.pkgd.min.js"></script>
    <script src="theme/medibazaar/assets/js/jquery.magnific-popup.min.js"></script>
    <script src="theme/medibazaar/assets/js/plugins.js"></script>
    <script src="theme/medibazaar/assets/js/main.js"></script>
</body>
