                                ...
                                <tbody>
                                    <tr>
                                        <td class="product-thumbnail"><a href="#"><img
                                                    src="assets/img/products/01.jpg" alt=""></a></td>
                                    ...
                                    <tr>
                                        <td class="product-thumbnail"><a href="#"><img
                                                    src="assets/img/products/02.jpg" alt=""></a></td>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="coupon-all">
                                    ...
                                    <div class="coupon2">
                                        <input class="c-btn theme-btn" name="update_cart" value="Update cart"
                                            type="submit">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-5 ml-auto">
                                <div class="cart-page-total">
                                    ...
                                    <a class="c-btn theme-btn" href="#">Proceed to checkout</a>
                                </div>
                            </div>
                        </div>
                    </form>
